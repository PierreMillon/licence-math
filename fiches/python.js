/* ============================================================
   ...
   (Pascal Ortiz, L1 INU Champollion) — chapitres I à IV (extrait,
   boucle for) : la suite (listes, boucle while, fonctions, chaînes
   de caractères) sera ajoutée dans un prochain passage.
   ============================================================ */
...
/* ---------- typographie (aucune formule LaTeX ici, juste du code) ---------- */
