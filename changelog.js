...
const VERSIONS = [
  { v: 121, date: "11/08/2026", desc: "<ul><li>Corrigé un débordement horizontal sur plusieurs pages (historique, réglages, mes erreurs, progression, révision) — un bug flexbox classique (min-width par défaut) faisait déborder la page sur mobile</li><li>Bulle de l'oiseau redessinée façon bande dessinée : fond noir, bord et texte blancs — fusionne le marqueur d'absence et la phrase taquine, qui alternent au hasard</li><li>Lune redessinée en « éclipse à deux cercles » : un vrai croissant (intersection de deux disques) au lieu d'un rectangle découpé</li><li>Densité du dragon (lundi-mercredi) recalée sur les plans de référence du site — il était flou/écrasé aux petites tailles</li><li>Police : plus de saut visuel au chargement (police de secours puis police du site) — attend que la police soit prête avant d'afficher le texte</li><li>Pièces d'équipement : un nom façon jeu vidéo au-dessus de chaque pièce sur la fiche</li><li>Infobulles (appui long / clic) sur 8 zones de la scène de combat expliquant à quoi elles correspondent</li><li>2 renvois entre cours de maths et chapitres de code, quand le lien est vraiment direct (logique ↔ Python)</li><li>Pièce d'or qui tourne de plus en plus vite pendant le tirage du « pull-to-refresh »</li></ul>" },
