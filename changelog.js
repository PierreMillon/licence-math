...
const VERSIONS = [
  { v: 98, date: "10/08/2026", desc: "<ul><li>Nouvelle page « MA PROGRESSION » (menu) : radar de maîtrise par chapitre, détail par chapitre, et un transfert de progression entre appareils sans compte (une phrase à copier-coller, rien envoyé à un serveur) — porté du site de Gaël, sans son système de pyramide à paliers</li><li>Nouvelle page « RÉVISION CIBLÉE », accessible depuis MA PROGRESSION et depuis MES ERREURS FRÉQUENTES (qui en devient le point d'entrée) : rejoue les 10 pires exercices tous chapitres confondus, dans un ordre mélangé — répondre là-bas met à jour la fiche d'origine exactement comme si on y répondait sur place</li><li>Blocage du dézoom et de l'effet élastique horizontal également appliqué sur alice-et-sophie, fiche-de-math-gael et exercices-l1-math</li></ul>" },
  { v: 97, date: "10/08/2026", desc: "<ul><li>Le menu affiche maintenant, à droite de chaque chapitre, le pourcentage de questions répondues (arrondi à l'unité)</li><li>56 nouvelles phrases dans la rotation de fin de fiche (question ouverte, ton encourageant), inspirées d'un texte personnel sur l'effort et la patience</li><li>20 nouvelles phrases dans le bandeau de l'accueil, même thème mais réécrites dans le ton habituel (Woody Allen / Poe / Lovecraft / Asimov), avec une touche Monty Python en plus</li></ul>" },
  { v: 96, date: "10/08/2026", desc: "<ul><li>Réglage par défaut (nouveaux visiteurs uniquement, sans préférence déjà enregistrée) : validation des réponses par bouton VALIDER au lieu d'immédiate</li><li>Impossible de dézoomer en dessous de l'affichage normal (déjà pile ajusté à l'écran) ; le zoom pour agrandir reste possible</li><li>Plus d'effet élastique en glissant horizontalement sur la page elle-même (hors zones de glissement des formules) — le site reste fixe</li><li>Petite phrase grise sous la barre de progression par carrés de chaque fiche : « cliquer sur un carré pour aller à l'exercice correspondant »</li></ul>" },
  { v: 95, date: "10/08/2026", desc: "<ul><li>Les formules ne se coupent plus jamais n'importe où (après un +, un =...) : chaque formule se lit désormais toujours d'un bloc, sur une seule ligne, glissable au doigt si elle est trop large pour l'écran — validé sur page de test avant déploiement, glissement verrouillé à l'horizontale uniquement</li><li>Le combat de la semaine affiche maintenant le temps restant avant la remise à zéro du lundi (« il reste 2j 14h »), pour situer sa progression dans la semaine</li></ul>" },
  { v: 94, date: "10/08/2026", desc: "<ul><li>Les formules trop larges pour l'écran vivent maintenant dans une zone signalée (bordure en pointillés + icône ↔) qu'on peut faire glisser latéralement, au lieu de déborder</li><li>Nouveau réglage « VALIDATION DES RÉPONSES » (page RÉGLAGES, ex-NOTATION) : bouton VALIDER optionnel au lieu d'une validation immédiate au clic</li><li>Nouveau réglage « AFFICHAGE DES FICHES » : retour au défilement continu en option, à la place de la pagination par défaut</li><li>Icône menu (cœur) déplacée à gauche, badge de version déplacé en bas à gauche avec un lien vers le code source depuis l'historique</li></ul> (Merci Charles Boyer pour les retours !)" },
  ...
  { v: 67, date: "04/08/2026", desc: "<ul><li>L'épée du bouton haut de page distingue à nouveau 3 contextes : gauche sur les fiches (retour à l'accueil), droite sur l'historique (retour de la version), vers le haut (orientation naturelle) une fois déjà à l'accueil</li><li>La scène chevalier/dragon/château passe tout en bas de l'accueil, sous tous les chapitres ; le score du combat hebdomadaire s'affiche directement en blanc dans le décor du château au lieu d'un texte séparé</li><li>Le badge d'équipement de chaque fiche passe en haut de page, juste sous le titre</li><li>Menu des chapitres : retire le titre « CHAPITRES » et sa ligne, retire les flèches devant « ACCUEIL », retire la ligne en trop sous Python</li></ul>" },
  ...
  { v: 60, date: "04/08/2026", desc: "<ul><li>Chaque fiche de chapitre affiche en bas de page une pièce d'équipement miniature qui se remplit selon la progression de la semaine (comme sur l'accueil et le chevalier de la scène de combat)</li><li>L'oiseau/dragon regarde maintenant vers le chevalier au lieu de lui tourner le dos</li><li>Scène de victoire : le chevalier se tient à côté du dragon vaincu au sol, épée plantée dans le dragon plutôt que dans sa main</li><li>Bouton « haut de page » : corrige un bug d'appuis rapides répétés qui pouvait faire sauter la page ; un petit mouvement indique désormais qu'on est déjà à l'accueil en haut de page</li></ul>" },
