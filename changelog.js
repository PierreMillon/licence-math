...
const VERSIONS = [
  { v: 79, date: "05/08/2026", desc: "<ul><li>L'oiseau décoratif de la scène de combat est deux fois plus petit, et son bas est maintenant aligné au pixel près sur le bas du chevalier (au lieu du bas de la colonne, pièces d'or comprises)</li><li>La barre de progression globale (petit carré par exercice) affiche maintenant un fin trait noir entre chaque segment, comme les barres de progression par chapitre</li><li>Les pièces d'équipement gagnées chaque semaine s'affichent à nouveau en surimpression sur le chevalier, cette fois sur le nouveau personnage en couleur au lieu de l'ancienne silhouette blanche — l'alignement restera approximatif tant que les pièces ne sont pas redessinées sur mesure pour cette silhouette</li></ul>" },
  { v: 78, date: "05/08/2026", desc: "Corrections suite aux retours : (1) la barre de progression globale reste dans son rectangle d'origine, une seule ligne, sans passer à la ligne — chaque exercice y est un segment fin qui s'écrase proportionnellement, au lieu d'une grille de petits carrés ; (2) les scènes de victoire et de défaite affichent maintenant le nouveau chevalier (personnage en couleur), plus l'ancienne silhouette blanche assemblée à partir des pièces d'équipement ; (3) notation d'équivalence (fiche Analyse) resserrée : le point est maintenant collé sous le tilde, comme dans la référence, au lieu d'avoir un espacement de type indice." },
  { v: 77, date: "05/08/2026", desc: "Gros lot de retouches sur la scène de combat et ailleurs : (1) le chevalier remplace entièrement l'ancien bonhomme blanc (silhouette d'équipement) ; (2) l'ancien château dessiné à la main a été retiré du fond ; (3) le contour de l'oiseau est maintenant fin et continu, de la même largeur qu'un pixel de l'oiseau ; (4) le texte « COMBAT DE LA SEMAINE » est passé sous les personnages, avec un espace noir au-dessus ; (5) un dragon distinct (silhouette dressée) a été ajouté pour la scène de défaite, à la place du dragon endormi ; (6) l'oiseau de la mascotte de progression cligne désormais aussi des yeux, pas seulement l'oiseau décoratif ; (7) la barre de progression globale affiche maintenant un petit carré par exercice du site (plus de 200) au lieu de segments par pourcentage — chaque bonne réponse en allume un de plus ; (8) correction d'un chevauchement entre le badge d'équipement et son étiquette sur certaines fiches (notamment Analyse), qui touchait toutes les pièces à l'aspect inhabituel ; (9) la notation d'équivalence de fonctions (fiche Analyse) s'écrit maintenant avec le point directement sous le tilde, comme dans les références du cours, au lieu d'un indice classique ; (10) nouvelle page de démonstration (demo-monstre.html) pour tester la traversée du petit monstre sans attendre 3 minutes." },
